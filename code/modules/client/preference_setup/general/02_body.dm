...
/datum/category_item/player_setup_item/physical/body/content(var/mob/user)
	...
	. += "Basic color: <a href='?src=\ref[src];base_skin=1'>[pref.s_base]</a><br>"

	. += "Skin tone: <a href='?src=\ref[src];skin_tone=1'>[-pref.s_tone + 35]/220</a><br>"

	. += "Need glasses: <a href='?src=\ref[src];disabilities=[NEARSIGHTED]'><b>[pref.disabilities & NEARSIGHTED ? "Yes" : "No"]</b></a><br><br>"
	...
	. += "<br><a href='?src=\ref[src];toggle_preview_value=[EQUIP_PREVIEW_JOB]'>[pref.equip_preview_mob & EQUIP_PREVIEW_JOB ? "Hide suit" : "Show suit"]</a>"
	. += "</td></tr></table>"
